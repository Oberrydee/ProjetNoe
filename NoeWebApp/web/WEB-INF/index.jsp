...
<body class="home">
	...
	<div class="navbar navbar-inverse navbar-fixed-top headroom" >
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.html"><img src="" alt="logo arche"></a>
			</div>
	...
	<header id="head">
		<div class="container">
			<div class="row">
				...
				<p><a class="btn btn-action btn-lg" role="button" href="signup.html">Inscription</a>
				<a class="btn btn-action btn-lg" role="button" href="contact.html">Nous contacter</a></p>
			</div>
		</div>
	</header>
	<!-- /Header -->
	...
	<div class="jumbotron top-space">
		<div class="container">
			...
			<h3 class="text-center thin" ><a href="galerie.html">Galerie images</a></h3>
